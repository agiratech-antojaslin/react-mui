                ...
                <Item>
                  <Card sx={{backgroundColor: 'rgb(248, 250, 252)', border: '1px solid rgb(238, 242, 246)', padding: '10px 20px'}}>
                    ...
                    <CardActions sx={{paddingLeft: "0px", paddingRight: '0px'}}>
                      <Button variant="outlined" startIcon={<PeopleOutlineOutlinedIcon />} sx={{width: '100%', margin: '10px 0 0 0'}}>Followed</Button>
                    </CardActions>
                  </Card>
                </Item>
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={3}>
                <Item>
                  <Card sx={{backgroundColor: 'rgb(248, 250, 252)', border: '1px solid rgb(238, 242, 246)', padding: '10px 20px'}}>
                    ...
                    <CardActions sx={{paddingLeft: "0px", paddingRight: '0px'}}>
                      <Button variant="contained" startIcon={<PersonAddOutlinedIcon />} sx={{width: '100%', margin: '10px 0 0 0'}}>Follow Back</Button>
                    </CardActions>
                  </Card>
                </Item>
            </Grid>
